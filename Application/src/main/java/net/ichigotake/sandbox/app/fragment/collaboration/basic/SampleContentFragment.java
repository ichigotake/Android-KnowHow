...
public class SampleContentFragment extends Fragment implements Pane {

    public static FragmentFactory<SampleContentFragment> factory() {
        return new FragmentFactory<SampleContentFragment>() {
            @Override
    ...
    private static class RequestOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            TwoColumnContainerImpl.get(activity).requestForSubContent();
        }
    }
}
